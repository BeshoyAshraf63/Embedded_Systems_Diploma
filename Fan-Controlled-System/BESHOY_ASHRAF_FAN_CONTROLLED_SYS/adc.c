 ...
 * File Name: adc.c
 *
 * Description: Source file for ATmega16 ADC driver (Pooling).
 *
 ...
 *                          Global Variables                                   *
 *******************************************************************************/
/* Global volatile varibale used in case interrupt mode is enabled */
volatile uint16 g_adcResult = 0;
/* Global volatile varibale flag used for Lm-Sensor in case interrupt mode is enabled */
